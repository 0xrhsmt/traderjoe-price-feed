export const LBFactoryABI = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'flashLoanFee', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'contract ILBPair', name: 'pair', type: 'address' }],
    name: 'forceDecay',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'flashLoanFee', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: 'pendingOwner_', type: 'address' }],
